...
let contract = new web3.eth.Contract(
  abi,
  "0xcC32dB54a697fEc47050a4A96d35A78Ba09f4dfD"
);
...
const sendEth = (totalAmount, totalArtists) => {
  ...
  web3.eth.getAccounts().then((accounts) => {
    contract.methods
      .sendToMany(
        [
          "0x917a68cC6F5C0CcEC69C9C0b3Bd9A4A88573b38C",
          "0x8Df125c833645119A6e4383c1805945eF7754Ef4",
        ],
        [divAmount, divAmount]
      )
      .send({ from: accounts[0], value: totalAmount })
      .then((data) => {
        console.log(data);
        location.href = "https://nft-art-gallery-64se.vercel.app/";
      });
  });
};
