function createUnityInstance(e, t, r) {
  ...
  function a(e) {
    ...
    if (
      ...
      var a = e.filename || (t && (t.fileName || t.sourceURL)) || "",
        o = e.lineno || (t && (t.lineNumber || t.line)) || 0;
      i(r, a, o);
    }
  }
  function o(e) {
  ...
  function s(e, t) {
    if ("symbolsUrl" != e) {
      ...
      for (var e in f.downloadProgress) {
        ...
        i++,
          n.lengthComputable
            ? ((a += n.loaded), (o += n.total), s++)
            : n.finished || l++;
      }
      var d = i ? (i - l - (o ? (s * (o - a)) / o : 0)) / i : 0;
      r(0.9 * d);
    }
  }
  function l(e, t, r) {
    for (var n in m)
      if (m[n].hasUnityMarker(e)) {
        t &&
          console.log(
        ...
        if (!a.worker) {
          ...
          (a.worker = new Worker(o)),
            (a.worker.onmessage = function (e) {
              return e.data.ready
                ? void URL.revokeObjectURL(o)
        ...
        return (
          (a.worker.callbacks[i] = r),
          void a.worker.postMessage({ id: i, compressed: e }, [e.buffer])
        );
      }
    r(e);
  }
    ...
    return new Promise(function (t, r) {
      ...
      a.open("GET", f[e]),
        ...
        a.addEventListener("load", function (r) {
          s(e, r), l(new Uint8Array(a.response), f[e], t);
        }),
      ...
      f.addRunDependency("dataUrl"),
        e.then(function (e) {
          ...
          for (r += 4; r < a; ) {
            ...
            f.FS_createDataFile(l, null, e.subarray(o, o + i), !0, !0, !0);
          }
  ...
  (f.SystemInfo = (function () {
    ...
    (a = f[a] || a),
      ...
      o &&
        ((gl = o.getContext("webgl2")),
        (glVersion = gl ? 2 : 0),
        gl || ((gl = o && o.getContext("webgl")) && (glVersion = 1)),
        gl &&
          (i =
    ...
    (f.XMLHttpRequest = (function () {
        ...
        return (
          a &&
            (["Last-Modified", "ETag"].forEach(function (e) {
              o.responseHeaders[e] = a.getResponseHeader(e);
            }),
      ...
      n.prototype.execute = function (e, t, r, n, a) {
        if (this.database)
          try {
            var o = this.database
              .transaction(
              ...
              .objectStore(e);
            "openKeyCursor" == t && ((o = o.index(r[0])), (r = r.slice(1)));
            var i = o[t].apply(o, r);
            "function" == typeof n &&
      ...
      (o.prototype.send = function (t) {
        var n = this.xhr,
          ...
          o = arguments;
        return (
          (a.enabled = a.enabled && "arraybuffer" == n.responseType && !t),
          a.enabled
            ? void d.execute(
                s.name,
                "get",
        ...
        (o.prototype.open = function (e, r, n, o, i) {
          return (
            (this.cache.result = a(
              t(r),
              this.cache.company,
      ...
      require: function (e) {
        var t = {
                  ...
                  ((0 !== f.avail_out &&
                    ...
                    ("string" === this.options.to
                      ? ((a = l.utf8border(f.output, f.next_out)),
                        ...
                        (f.next_out = o),
                        (f.avail_out = p - o),
                        o && s.arraySet(f.output, f.output, a, o, 0),
                        this.onData(u))
          ...
          "utils/common.js": function (e, t, r) {
            ...
            var a = {
                ...
                flattenChunks: function (e) {
                  ...
                  for (
                    i = new Uint8Array(n), a = 0, t = 0, r = e.length;
                    t < r;
                    t++
                  )
          ...
          "utils/strings.js": function (e, t, r) {
            ...
            (s[254] = s[254] = 1),
              (r.string2buf = function (e) {
                ...
                for (t = new a.Buf8(l), i = 0, o = 0; i < l; o++)
                  (r = e.charCodeAt(o)),
                    55296 === (64512 & r) &&
                      o + 1 < s &&
                      ((n = e.charCodeAt(o + 1)),
              ...
              (r.binstring2buf = function (e) {
                for (
                  var t = new a.Buf8(e.length), r = 0, n = t.length;
                  r < n;
                  r++
                )
                  t[r] = e.charCodeAt(r);
              ...
              (r.buf2string = function (e, t) {
                var r,
                  ...
                  d = new Array(2 * l);
                for (a = 0, r = 0; r < l; )
                  if (((o = e[r++]), o < 128)) d[a++] = o;
                  else if (((i = s[o]), i > 4)) (d[a++] = 65533), (r += i - 1);
                  else {
                    for (o &= 2 === i ? 31 : 3 === i ? 15 : 7; i > 1 && r < l; )
                      (o = (o << 6) | (63 & e[r++])), i--;
                    i > 1
                      ? (d[a++] = 65533)
                      : o < 65536
          ...
          "zlib/inflate.js": function (e, t, r) {
            ...
            function c(e, t, r, n) {
              ...
              return (
                ...
                n >= o.wsize
                  ...
                  : ((a = o.wsize - o.wnext),
                    a > n && (a = n),
                    g.arraySet(o.window, t, r - n, a, o.wnext),
                    (n -= a),
                    n
                      ? (g.arraySet(o.window, t, r - n, n, 0),
                        (o.wnext = n),
                        (o.whave = o.wsize))
                      : ((o.wnext += a),
                ...
                switch (r.mode) {
                    ...
                    if (
                      ...
                      m &&
                        (r.head &&
                          ...
                          g.arraySet(r.head.extra, a, i, m, xe)),
                        512 & r.flags && (r.check = y(r.check, a, m, i)),
                        (l -= m),
                        (i += m),
                        (r.length -= m)),
                      r.length)
                  ...
                  case ee:
                    ...
                    if (
                      ...
                      (r.lenbits = 7),
                      (Ee = { bits: r.lenbits }),
                      (_e = x(_, r.lens, 0, 19, r.lencode, 0, r.work, Ee)),
                      (r.lenbits = Ee.bits),
                      _e)
                    ) {
                  ...
                  case te:
                    ...
                    if (
                      ((r.lenbits = 9),
                      (Ee = { bits: r.lenbits }),
                      (_e = x(E, r.lens, 0, r.nlen, r.lencode, 0, r.work, Ee)),
                      (r.lenbits = Ee.bits),
                      _e)
                    ) {
                  ...
                  case se:
                    ...
                    if (((m = b - d), r.offset > m)) {
                      ...
                      m > r.wnext
                        ...
                        (be = r.window);
                    } else (be = o), (w = s - r.offset), (m = r.length);
                ...
                c(e, e.output, e.next_out, b - e.avail_out)
                  ...
                  : ((p -= e.avail_in),
                    ...
                    r.wrap &&
                      ...
                      (e.adler = r.check =
                        r.flags
                          ? y(r.check, o, b, e.next_out - b)
                          : v(r.check, o, b, e.next_out - b)),
                    (e.data_type =
                      r.bits +
                      (r.last ? 64 : 0) +
                      (r.mode === K ? 128 : 0) +
                      (r.mode === re || r.mode === Q ? 256 : 0)),
                    ((0 === p && 0 === b) || t === C) && _e === L && (_e = I),
                    _e)
              );
            }
            function h(e) {
            ...
            function p(e, t) {
              ...
              return e && e.state
                ? ((r = e.state),
                  0 === (2 & r.wrap) ? A : ((r.head = t), (t.done = !1), L))
                : A;
            }
            function b(e, t) {
              var r,
          ...
          "zlib/adler32.js": function (e, t, r) {
            ...
            function n(e, t, r, n) {
              for (
                var a = (65535 & e) | 0, o = ((e >>> 16) & 65535) | 0, i = 0;
                0 !== r;

              ) {
                (i = r > 2e3 ? 2e3 : r), (r -= i);
                do (a = (a + t[n++]) | 0), (o = (o + a) | 0);
                while (--i);
                (a %= 65521), (o %= 65521);
              }
              return a | (o << 16) | 0;
          ...
          "zlib/inftrees.js": function (e, t, r) {
            ...
            t.exports = function (e, t, r, p, b, m, w, g) {
              var v,
                ...
                W = 0;
              for (L = 0; L <= a; L++) Z[L] = 0;
              for (T = 0; T < p; T++) Z[t[r + T]]++;
              for (H = B, A = a; A >= 1 && 0 === Z[A]; A--);
              if ((H > A && (H = A), 0 === A))
                return (
                  (b[m++] = 20971520), (b[m++] = 20971520), (g.bits = 1), 0
                );
              for (U = 1; U < A && 0 === Z[U]; U++);
              for (H < U && (H = U), N = 1, L = 1; L <= a; L++)
                if (((N <<= 1), (N -= Z[L]), N < 0)) return -1;
              if (N > 0 && (e === s || 1 !== A)) return -1;
              for (M[1] = 0, L = 1; L < a; L++) M[L + 1] = M[L] + Z[L];
              for (T = 0; T < p; T++) 0 !== t[r + T] && (w[M[t[r + T]]++] = T);
              if (
                (e === s
                  ? ((F = j = w), (E = 19))
                  : e === l
                  ? ((F = u), (P -= 257), (j = c), (W -= 257), (E = 256))
                  : ((F = f), (j = h), (E = -1)),
                (z = 0),
                (T = 0),
                (L = U),
              ...
              for (;;) {
                ...
                if (L > H && (z & x) !== k) {
                  for (
                    0 === I && (I = H), _ += U, O = L - I, N = 1 << O;
                    O + I < A && ((N -= Z[O + I]), !(N <= 0));

                  )
                    O++, (N <<= 1);
                  if (((D += 1 << O), (e === l && D > o) || (e === d && D > i)))
                    return 1;
                  (k = z & x), (b[k] = (H << 24) | (O << 16) | (_ - m) | 0);
                }
              }
              return (
                0 !== z && (b[_ + z] = ((L - I) << 24) | (64 << 16) | 0),
                (g.bits = H),
                0
              );
            };
        ...
        var n = function (e) {
          ...
          o = function (e, t) {
            ...
            return (
              r.exports ||
                ((r.parent = e), r(o.bind(null, r), r, (r.exports = {}))),
              r.exports
            );
          };
        return o(null, e);
